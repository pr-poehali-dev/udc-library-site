...
const LibraryResources = () => {
  const resources = [
    {
      ...
      description: "Учебники и учебные пособия по всем направлениям подготовки",
      count: "8,500+ изданий",
    },
    {
      icon: "ScrollText",
      ...
      description:
        "Методические указания и разработки преподавателей института",
      count: "1,200+ материалов",
    },
    {
      icon: "Newspaper",
      title: "Периодические издания",
      description: "Научные журналы и образовательные периодические издания",
      count: "50+ наименований",
    },
    {
      icon: "FileText",
      title: "Диссертации и авторефераты",
      description: "Научные работы выпускников и исследователей",
      count: "300+ работ",
    },
  ];
  ...
  const databases = [
    {
      name: "ЭБС Юрайт",
      description: "Образовательная платформа с учебниками и курсами",
      icon: "Database",
    },
    {
      name: "eLIBRARY.RU",
      description: "Научная электронная библиотека",
      icon: "Search",
    },
    {
      name: "Консультант Плюс",
      description: "Справочно-правовая система",
      icon: "Scale",
    },
    {
      name: "Электронный каталог",
      description: "Каталог фондов библиотеки СВФУ",
      icon: "BookMarked",
    },
  ];
